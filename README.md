...
This project aims to create stealth addresses for Ethereum Virtual Machine (EVM) compatible Blockchains.
...
These addresses must be created using Rust Programming Language and Web3/EVM compatible Elliptic Curve
algorithms.
